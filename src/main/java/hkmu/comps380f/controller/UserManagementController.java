...
public class UserManagementController {
    ...
    public static class Form {
        private String username;  private String password;  private String[] roles;  private String discription; private String emailaddr;
    ...
    public String create(Form form) throws IOException {
        umService.createTicketUser(form.getUsername(), form.getPassword(), form.getRoles(), form.getEmailaddr());
